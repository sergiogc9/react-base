...
const defaultData: TestData[] = range(0, 100).map(num => ({ id: num, name: faker.name.firstName() }));
...
describe('TablePagination', () => {
	...
	it('should render pagination info with custom page count with providing exact rows length', () => {
		getComponent({}, { tableOptions: { manualPagination: true }, pageCount: 100, rowsCount: 950 });
