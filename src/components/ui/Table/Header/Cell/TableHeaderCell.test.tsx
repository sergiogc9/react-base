...
const defaultProps: RecursivePartial<TableHeaderCellProps> = {
	column: { canSort: false, isSorted: false, isSortedDesc: false, toggleSortBy: mockOnToggleSortBy }
};
...
describe('TableHeaderCell', () => {
	...
	it('should render down arrow if sorting enabled and column sorted desc', () => {
		const { container } = getComponent({ column: { canSort: true, isSorted: true, isSortedDesc: true } });
	...
	it('should render down arrow if sorting enabled and column sorted asc', () => {
		const { container } = getComponent({ column: { canSort: true, isSorted: true, isSortedDesc: false } });
