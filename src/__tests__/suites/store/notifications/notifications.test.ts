...
import { getFullState, getStore } from '__tests__/utils/redux';
...
describe('Notifications store', () => {
	...
	it('should remove a notification', () => {
		expect(reducers(
			getFullState({ notifications: { items: { 123456789123450: notification } } }),
	...
	it('should call getNotifications selector', () => {
		...
		expect(selectors.getNotifications(store.getState())).toEqual({ 123456789123450: notification });
	});
